...
`,
        ...
        `Вам нужно граффити с обратной стороны загаданного здания. Помимо прочего у персонажа в волосах застряла табличка, которую вам надо рассмотреть. Назовите категорию помещения.` + getVideo(true, 'https://www.youtube.com/embed/bYsl0GIZmD4')
    ],
